...
- `dynamic_nss`: Thin wrapper around `nss` that exposes the dynamic NS regime
                 (``num_delete > 1``) as a first-class API.
- `hamiltonian`: Gradient-guided Hamiltonian Nested Sampling using likelihood
                 surface reflections.
